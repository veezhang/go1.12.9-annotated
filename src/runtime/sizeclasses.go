...
const (
	_MaxSmallSize   = 32768 // 最大的小类型 32kB
	smallSizeDiv    = 8
	smallSizeMax    = 1024
	largeSizeDiv    = 128
	_NumSizeClasses = 67 // 大小类型的数目
	_PageShift      = 13 // 管理虚拟地址页大小为 8k， 1<<13
)
...
// 从span偏移计算对象编号
// size为类型 bytes/obj，代表对象的字节数，n是偏移量
// n / size = n >> c.shift * c.mul >> c.shift2
// baseMask如果size是2的幂， baseMask = 1<<16 - size，否侧是0
// 拿第4个来计算：divMagic: {4, 9, 171, 0}
// 4         48        8192      170          32     31.52%
// 0 / 48 = 0 >> 4 * 171 >> 9 = 0
// ...
// 47 / 48 = 47 >> 4 * 171 >> 9 = 0
